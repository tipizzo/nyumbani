<div className=" flex items-stretch w-full justify-around bg-gray-50 py-14">

                <div className="flex flex-col gap-1 max-w-[350px] cursor-pointer rounded-xl shadow-xl hover:bg-gray-100 transition-all duration-300">
                    <Image
